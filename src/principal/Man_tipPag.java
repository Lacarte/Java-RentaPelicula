 ...
 * @author LCRT
 */
public class Man_tipPag extends javax.swing.JInternalFrame {
    ...
    String tableName = "tb_tipo_pago";
    String idColname = "codtipopag";
    String descriptionColname = "destippag";
...
//////clear and populate////////////  
    ...
    public void populateGenero(String tblname) {
        ...
        try {
            ...
            Logger.getLogger(Man_tipPag.class
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Mantenimiento Tipo Pago");
        ...
        jLabel3.setText("Descripcion Tipo Pago");
        ...
        jLabel5.setText("Mantenimiento Tipo Pago");
