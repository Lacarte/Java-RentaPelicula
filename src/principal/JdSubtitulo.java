...
public class JdSubtitulo extends javax.swing.JDialog {
    ...
    public JdSubtitulo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        sql = new DBSql();
    ...
    public void populateIdioma(String tblname) {
        ...
        try {
            ...
            tblIdioma.setModel(tm);
            //old
            //jtCars.setModel(rst.rstomodel(rs));
            lbInfo.setText("Ctd : " + tblIdioma.getRowCount());
        } catch (SQLException ex) {
            Logger.getLogger(JdSubtitulo.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 //////////////////////end try/////////////////      
    ...
    void detectIdAlreadyAdded() {
        ...
        for (int i = 0; i < Man_pel.lstSubtituloModel.getSize(); i++) {
            DataJlist selected_item = (DataJlist) Man_pel.lstSubtituloModel.elementAt(i);
    ...
    public void populateGeneroViaFilter(String tblname) {
        ...
        tblIdioma.remove(this);
        try {
            tblIdioma.setModel(rst.rstomodel(rs));
            lbInfo.setText("Ctd : " + tblIdioma.getRowCount());
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtBusqueda, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
    ...
    private void tblIdiomaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblIdiomaMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (tblIdioma.getSelectedRow() > -1) {

                boolean exist = false;
                // print first column value from selected row
                int id = Integer.parseInt(tblIdioma.getValueAt(tblIdioma.getSelectedRow(), 0).toString());
                String data = tblIdioma.getValueAt(tblIdioma.getSelectedRow(), 1).toString();
                ...
                if (exist) {
                    ...
                    Man_pel.addRemoveElementFromSubtitulo(id, true);
                    Man_pel.lstSubtituloModel.addElement(new DataJlist(id, data));
    ...
    private void timer1OnTime(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_timer1OnTime
        ...
        if (progVal >= jProgressBar1.getMaximum()) {
            ...
            Man_pel.PnlSubtitulo.setBorder(javax.swing.BorderFactory.createTitledBorder("Subtitulo(s): " + Man_pel.lstSubtitulo.getModel().getSize()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdSubtitulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdSubtitulo dialog = new JdSubtitulo(new javax.swing.JFrame(), true);
