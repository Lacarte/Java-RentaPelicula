 ...
 * @author LCRT
 */
public class Man_for extends javax.swing.JInternalFrame {
    ...
    String tableName = "tbformato";
    String idColname = "codfor";
    String descriptionColname = "desfor";
...
//////clear and populate////////////  
    ...
    public void populateGenero(String tblname) {
        ...
        try {
            ...
            Logger.getLogger(Man_for.class
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Mantenimiento Formato");
        ...
        jLabel3.setText("Descripcion Formato");
        ...
        jLabel5.setText("Mantenimiento Formato");
