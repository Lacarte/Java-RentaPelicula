...
public class JdTodoLosClientesDevolucion extends javax.swing.JDialog {
    ...
    public JdTodoLosClientesDevolucion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        sql = new DBSql();
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (tblCliente.getSelectedRow() > -1) {
                ...
                if (PromptResult == JOptionPane.YES_OPTION) {
                    ...
                    int idData = Integer.parseInt((tblCliente.getModel().getValueAt(selectedRow, 0).toString()));
                    Tra_dev.codCli = idData;

                    getSelectRowIdData();

                   Tra_dev.lblCliCode.setText(tblCliente.getModel().getValueAt(selectedRow, 0).toString());
                   Tra_dev.lblCliName.setText(tblCliente.getModel().getValueAt(selectedRow, 1).toString()+" "+tblCliente.getModel().getValueAt(selectedRow, 2).toString());
                   Tra_dev.lblCliCedula.setText(tblCliente.getModel().getValueAt(selectedRow, 3).toString());
                   
                    confirmStringToDelete = null;
                    rowIdData = 0;
                    Tra_dev.btnBusca.doClick();
                    this.dispose();
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdTodoLosClientesDevolucion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdTodoLosClientesDevolucion dialog = new JdTodoLosClientesDevolucion(new javax.swing.JFrame(), true);
