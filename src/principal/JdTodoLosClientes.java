...
public class JdTodoLosClientes extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdTodoLosClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdTodoLosClientes dialog = new JdTodoLosClientes(new javax.swing.JFrame(), true);
