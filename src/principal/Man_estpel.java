 ...
 * @author LCRT
 */
public class Man_estpel extends javax.swing.JInternalFrame {
    ...
    String tableName = "tb_estado_pelicula";
    String idColname = "codestpel";
    String descriptionColname = "desest";
...
//////clear and populate////////////  
    ...
    public void populateGenero(String tblname) {
        ...
        try {
            ...
            Logger.getLogger(Man_estpel.class
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Mantenimiento Estado Pelicula");
        ...
        jLabel3.setText("Descripcion Estado Pelicula");
        ...
        jLabel5.setText("Mantenimiento Estado Pelicula");
