...
//     
	...
	private final String PASSWORD = "";
	private final String H_CONN_STRING =
			"jdbc:hsqldb:data/rentapelicula";
	private final String M_CONN_STRING =
			"jdbc:mysql://127.0.0.1/rentapelicula";
        
        
        /////////////////remote/////////

        /*
        private final String USERNAME = "lcrtdb";
	private final String PASSWORD = "Lcrtbin01@";
	private final String H_CONN_STRING =
			"jdbc:hsqldb:data/biblioteca";
	private final String M_CONN_STRING =
			"jdbc:mysql://lcrtdb.db.11978674.hostedresource.com/lcrtdb";
